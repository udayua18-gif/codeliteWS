...
int main()
{
    ...
    <<(price_per_small_rooms*small_rooms)+
       (price_per_large_rooms*large_rooms)<<endl;
       
    cout<<"Tax:$"
    <<((price_per_small_rooms*small_rooms)+
       (price_per_large_rooms*large_rooms))*sales_tax<<endl;
       
    cout<<"================================================="<<endl;
    cout<<"Total estimate:$"
    <<((price_per_small_rooms*small_rooms)+(price_per_large_rooms*large_rooms))+
    (((price_per_small_rooms*small_rooms)+(price_per_large_rooms*large_rooms))*sales_tax)<<endl;
